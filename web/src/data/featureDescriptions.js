export default {
    ...
    tempo: (
        `
            The overall estimated tempo of a track in beats per minute (billboard.viz normalizes this number between zero and one). In musical terminology, tempo is the speed or pace of a given piece and derives directly from the average beat duration. The distribution of values for this feature look like this:
        `
    )
}